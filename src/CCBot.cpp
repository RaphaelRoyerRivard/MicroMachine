...
void CCBot::IssueGameStartCheats()
{
	...
	/*Debug()->DebugCreateUnit(sc2::UNIT_TYPEID::PROTOSS_STALKER, nat + towardsCenter * 15 + towardsCenterY * 5, player1, 15);
	Debug()->DebugCreateUnit(sc2::UNIT_TYPEID::PROTOSS_IMMORTAL, nat + towardsCenter * 15 + towardsCenterY * 5, player1, 3);
	Debug()->DebugCreateUnit(sc2::UNIT_TYPEID::PROTOSS_OBSERVER, nat + towardsCenter * 15 + towardsCenterY * 5, player1, 1);
