	...
	if (m_bot.GetSelfRace() == sc2::Race::Terran)
	{
		...
		switch (currentStrategy)
		{
			case TERRAN_CLASSIC :
			{
				...
				if (barracksCount < 10 && (barracksCount < 1 || startPumpingOutMarauders || buildMoreBarracksAgainstMultiGateways || (hasFusionCore && m_bot.GetFreeMinerals() >= 550 /*For a BC and a Barracks*/ && (barracksCount * 2 < finishedBaseCount || m_bot.GetFreeMinerals() >= 800))))
				{
