...
struct MiningSpeed {
    ...
    void simulateMining (libvoxelbot::BuildState& state, float dt) const;
...
struct BuildEvent {
    ...
    void apply(libvoxelbot::BuildState& state) const;
