...
#include "src/libvoxelbot/buildorder/build_state.h"
#include "src/libvoxelbot/buildorder/optimizer.h"
...
template <class Archive>
void serialize(Archive& archive, libvoxelbot::BuildState& state) {
    archive(
