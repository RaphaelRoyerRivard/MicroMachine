...
void MetaTypeEnum::Initialize(CCBot & m_bot)
{
	...
	MetaTypeEnum::GhostAcademy = MetaType("GhostAcademy", m_bot);
		//Units
	...
	MetaTypeEnum::Ghost = MetaType("Ghost", m_bot);
	MetaTypeEnum::Hellion = MetaType("Hellion", m_bot);
	MetaTypeEnum::WidowMine = MetaType("WidowMine", m_bot);
	...
	MetaTypeEnum::Liberator = MetaType("Liberator", m_bot);
	...
	MetaTypeEnum::SiegeTank = MetaType("SiegeTank", m_bot);
		//Upgrades
