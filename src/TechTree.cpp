...
void TechTree::initUnitTypeData()
{
	...
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_DRONEBURROWED, m_bot)] =				 { sc2::Race::Zerg, 0, 0, 1, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_DRONE, 0,{ UnitType(sc2::UNIT_TYPEID::ZERG_LARVA, m_bot) },{},{} };
