...
void TechTree::initUnitTypeData()
{
	...
	m_unitTypeData[UnitType(Util::GetRichAssimilatorId(m_bot), m_bot)] = { sc2::Race::Protoss, 0, 0, 0, 0, true, true, false,  true, false, false, false, sc2::ABILITY_ID::BUILD_ASSIMILATOR, 0, { UnitType(sc2::UNIT_TYPEID::PROTOSS_PROBE, m_bot) }, {}, {} };
	...
	m_unitTypeData[UnitType(Util::GetRichExtractorId(m_bot), m_bot)] =					{ sc2::Race::Zerg, 0, 0, 0, 0, true, true, false,  true, false, false, false, sc2::ABILITY_ID::BUILD_EXTRACTOR, 0,{ UnitType(sc2::UNIT_TYPEID::ZERG_DRONE, m_bot) },{},{} };
