...
void TechTree::onStart()
{
    initUnitTypeData();
    initUpgradeData();
	initBuildingAbilitiesProductionTypes();
...
void TechTree::initUnitTypeData()
{
	...
	m_unitTypeData[UnitType(Util::GetRichAssimilatorId(), m_bot)] = { sc2::Race::Protoss, 0, 0, 0, 0, true, true, false,  true, false, false, false, sc2::ABILITY_ID::BUILD_ASSIMILATOR, 0, { UnitType(sc2::UNIT_TYPEID::PROTOSS_PROBE, m_bot) }, {}, {} };
	...
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::PROTOSS_SHIELDBATTERY, m_bot)] =			 { sc2::Race::Protoss, 0, 0, 0, 0, true, true, false, false, false, false, false, sc2::ABILITY_ID::BUILD_SHIELDBATTERY, 0, { UnitType(sc2::UNIT_TYPEID::PROTOSS_PROBE, m_bot) }, { UnitType(sc2::UNIT_TYPEID::PROTOSS_CYBERNETICSCORE, m_bot) },{} };
    ...
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::PROTOSS_ADEPTPHASESHIFT, m_bot)] =         { sc2::Race::Protoss, 0, 0, 2, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::EFFECT_ADEPTPHASESHIFT, 0, { UnitType(sc2::UNIT_TYPEID::PROTOSS_ADEPT, m_bot) }, {} };
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::PROTOSS_ARCHON, m_bot)] =                  { sc2::Race::Protoss, 0, 0, 2, 0, true, false, false, false, false, false, false, 0, 0,{ UnitType() },{ UnitType() }, {} };
    ...
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::PROTOSS_WARPPRISMPHASING, m_bot)] =        { sc2::Race::Protoss, 0, 0, 2, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_WARPPRISM, 0, { UnitType(sc2::UNIT_TYPEID::PROTOSS_ROBOTICSFACILITY, m_bot) }, {}, {} }; 
	...
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::PROTOSS_OBSERVERSIEGEMODE, m_bot)] =		{ sc2::Race::Protoss, 0, 0, 1, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_OBSERVER, 0, { UnitType(sc2::UNIT_TYPEID::PROTOSS_ROBOTICSFACILITY, m_bot) }, {}, {} };
	...
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::TERRAN_REFINERYRICH, m_bot)] =				{ sc2::Race::Terran, 0, 0, 0, 0, true, true, false,  true, false, false, false, sc2::ABILITY_ID::BUILD_REFINERY, 0,{ UnitType(sc2::UNIT_TYPEID::TERRAN_SCV, m_bot) },{},{} };
    ...
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::TERRAN_REACTOR, m_bot)] =                  { sc2::Race::Terran, 0, 0, 0, 0, true, true, false, false, false, false, true, sc2::ABILITY_ID::BUILD_REACTOR_BARRACKS, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_BARRACKS, m_bot) }, {}, {} };
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::TERRAN_TECHLAB, m_bot)] =                  { sc2::Race::Terran, 0, 0, 0, 0, true, true, false, false, false, false, true, sc2::ABILITY_ID::BUILD_TECHLAB, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_BARRACKS, m_bot) }, {}, {} };
    ...
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::TERRAN_SCV, m_bot)] =                      { sc2::Race::Terran, 0, 0, 1, 0, true, false,  true, false, false, false, false, sc2::ABILITY_ID::TRAIN_SCV, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_COMMANDCENTER, m_bot), UnitType(sc2::UNIT_TYPEID::TERRAN_ORBITALCOMMAND, m_bot), UnitType(sc2::UNIT_TYPEID::TERRAN_PLANETARYFORTRESS, m_bot) }, {}, {} };
    ...
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::TERRAN_KD8CHARGE, m_bot)] =                { sc2::Race::Terran, 0, 0, 1, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::EFFECT_CHARGE, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_REAPER, m_bot) }, {}, {} };
    ...
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::TERRAN_HELLIONTANK, m_bot)] =              { sc2::Race::Terran, 0, 0, 2, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_HELLION, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_FACTORY, m_bot) }, {}, {} }; 
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::TERRAN_CYCLONE, m_bot)] =                  { sc2::Race::Terran, 0, 0, 3, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_CYCLONE, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_FACTORY, m_bot) }, { UnitType(sc2::UNIT_TYPEID::TERRAN_FACTORYTECHLAB, m_bot) }, {} };
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::TERRAN_SIEGETANK, m_bot)] =                { sc2::Race::Terran, 0, 0, 3, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_SIEGETANK, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_FACTORY, m_bot) }, { UnitType(sc2::UNIT_TYPEID::TERRAN_FACTORYTECHLAB, m_bot) }, {} };
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::TERRAN_SIEGETANKSIEGED, m_bot)] =          { sc2::Race::Terran, 0, 0, 3, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::MORPH_SIEGEMODE, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_SIEGETANK, m_bot) }, {}, {} };
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::TERRAN_THOR, m_bot)] =                     { sc2::Race::Terran, 0, 0, 6, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_THOR, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_FACTORY, m_bot) }, { UnitType(sc2::UNIT_TYPEID::TERRAN_FACTORYTECHLAB, m_bot), UnitType(sc2::UNIT_TYPEID::TERRAN_ARMORY, m_bot) }, {} };
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::TERRAN_THORAP, m_bot)] =                   { sc2::Race::Terran, 0, 0, 6, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_THOR, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_FACTORY, m_bot) }, { UnitType(sc2::UNIT_TYPEID::TERRAN_FACTORYTECHLAB, m_bot), UnitType(sc2::UNIT_TYPEID::TERRAN_ARMORY, m_bot) }, {} };
    ...
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::TERRAN_WIDOWMINEBURROWED, m_bot)] =        { sc2::Race::Terran, 0, 0, 2, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_WIDOWMINE, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_FACTORY, m_bot) }, {}, {} }; 
    ...
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::TERRAN_BANSHEE, m_bot)] =                  { sc2::Race::Terran, 0, 0, 3, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_BANSHEE, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_STARPORT, m_bot) }, { UnitType(sc2::UNIT_TYPEID::TERRAN_STARPORTTECHLAB, m_bot) }, {} };
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::TERRAN_BATTLECRUISER, m_bot)] =            { sc2::Race::Terran, 0, 0, 6, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_BATTLECRUISER, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_STARPORT, m_bot) }, { UnitType(sc2::UNIT_TYPEID::TERRAN_STARPORTTECHLAB, m_bot), UnitType(sc2::UNIT_TYPEID::TERRAN_FUSIONCORE, m_bot) }, {} };
    ...
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::TERRAN_LIBERATORAG, m_bot)] =              { sc2::Race::Terran, 0, 0, 3, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::MORPH_LIBERATORAGMODE, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_LIBERATOR, m_bot) }, {}, {} }; 
    ...
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::TERRAN_VIKINGASSAULT, m_bot)] =            { sc2::Race::Terran, 0, 0, 2, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_VIKINGFIGHTER, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_STARPORT, m_bot) }, {}, {} }; 
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::TERRAN_RAVEN, m_bot)] =                    { sc2::Race::Terran, 0, 0, 2, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_RAVEN, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_STARPORT, m_bot) }, { UnitType(sc2::UNIT_TYPEID::TERRAN_STARPORTTECHLAB, m_bot) }, {} };
    ...
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::TERRAN_MULE, m_bot)] =                     { sc2::Race::Terran, 0, 0, 0, 0, true, false, true, false, false, false, false, sc2::ABILITY_ID::EFFECT_CALLDOWNMULE, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_ORBITALCOMMAND, m_bot) }, {}, {} }; 
	...
	m_unitTypeData[UnitType(Util::GetRichExtractorId(), m_bot)] =					{ sc2::Race::Zerg, 0, 0, 0, 0, true, true, false,  true, false, false, false, sc2::ABILITY_ID::BUILD_EXTRACTOR, 0,{ UnitType(sc2::UNIT_TYPEID::ZERG_DRONE, m_bot) },{},{} };
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_LURKERDENMP, m_bot)] =				 { sc2::Race::Zerg, 0, 0, 0, 0, true, true, false,  true, false, false, false, sc2::ABILITY_ID::BUILD_EXTRACTOR, 0,{ UnitType(sc2::UNIT_TYPEID::ZERG_DRONE, m_bot) },{},{} };
	...
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_OVERLORDCOCOON, m_bot)] =			 { sc2::Race::Zerg, 0, 0, 0, 0, true, false, false, false,  true, false, false, sc2::ABILITY_ID::MORPH_OVERLORDTRANSPORT, 0,{ UnitType(sc2::UNIT_TYPEID::ZERG_OVERLORD, m_bot) },{},{} };
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_TRANSPORTOVERLORDCOCOON, m_bot)] =    { sc2::Race::Zerg, 0, 0, 0, 0, true, false, false, false,  true, false, false, sc2::ABILITY_ID::MORPH_OVERLORDTRANSPORT, 0, { UnitType(sc2::UNIT_TYPEID::ZERG_OVERLORD, m_bot) }, {}, {} };
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_OVERLORDTRANSPORT, m_bot)] =			 { sc2::Race::Zerg, 0, 0, 0, 0, true, false, false, false,  true, false, false, sc2::ABILITY_ID::MORPH_OVERLORDTRANSPORT, 0,{ UnitType(sc2::UNIT_TYPEID::ZERG_OVERLORD, m_bot) },{},{} };
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_OVERSEER, m_bot)] =					 { sc2::Race::Zerg, 0, 0, 0, 0, true, false, false, false,  true, false, false, sc2::ABILITY_ID::MORPH_OVERLORDTRANSPORT, 0,{ UnitType(sc2::UNIT_TYPEID::ZERG_OVERLORD, m_bot) },{},{} };
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_BANELING, m_bot)] =                   { sc2::Race::Zerg, 0, 0, 0, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_BANELING, 0, { UnitType(sc2::UNIT_TYPEID::ZERG_BANELINGCOCOON, m_bot) }, { UnitType(sc2::UNIT_TYPEID::ZERG_BANELINGNEST, m_bot) }, {} };
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_BANELINGBURROWED, m_bot)] =			 { sc2::Race::Zerg, 0, 0, 0, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_BANELING, 0,{ UnitType(sc2::UNIT_TYPEID::ZERG_BANELINGCOCOON, m_bot) },{ UnitType(sc2::UNIT_TYPEID::ZERG_BANELINGNEST, m_bot) },{} };
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_BANELINGCOCOON, m_bot)] =             { sc2::Race::Zerg, 0, 0, 0, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_BANELING, 0, { UnitType(sc2::UNIT_TYPEID::ZERG_ZERGLING, m_bot) }, { UnitType(sc2::UNIT_TYPEID::ZERG_BANELINGNEST, m_bot) }, {} };
	...
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_LURKERMP, m_bot)] =					 { sc2::Race::Zerg, 0, 0, 2, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_CORRUPTOR, 0,{ UnitType(sc2::UNIT_TYPEID::ZERG_LARVA, m_bot) },{ UnitType(sc2::UNIT_TYPEID::ZERG_SPIRE, m_bot), UnitType(sc2::UNIT_TYPEID::ZERG_GREATERSPIRE, m_bot) },{} };
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_LURKERMPBURROWED, m_bot)] =			 { sc2::Race::Zerg, 0, 0, 2, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_CORRUPTOR, 0,{ UnitType(sc2::UNIT_TYPEID::ZERG_LARVA, m_bot) },{ UnitType(sc2::UNIT_TYPEID::ZERG_SPIRE, m_bot), UnitType(sc2::UNIT_TYPEID::ZERG_GREATERSPIRE, m_bot) },{} };
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_LURKERMPEGG, m_bot)] =				 { sc2::Race::Zerg, 0, 0, 2, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_CORRUPTOR, 0,{ UnitType(sc2::UNIT_TYPEID::ZERG_LARVA, m_bot) },{ UnitType(sc2::UNIT_TYPEID::ZERG_SPIRE, m_bot), UnitType(sc2::UNIT_TYPEID::ZERG_GREATERSPIRE, m_bot) },{} };
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_INFESTORTERRAN, m_bot)] =			 { sc2::Race::Zerg, 0, 0, 2, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_CORRUPTOR, 0,{ UnitType(sc2::UNIT_TYPEID::ZERG_LARVA, m_bot) },{ UnitType(sc2::UNIT_TYPEID::ZERG_SPIRE, m_bot), UnitType(sc2::UNIT_TYPEID::ZERG_GREATERSPIRE, m_bot) },{} };
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_INFESTEDTERRANSEGG, m_bot)] =		 { sc2::Race::Zerg, 0, 0, 2, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_CORRUPTOR, 0,{ UnitType(sc2::UNIT_TYPEID::ZERG_LARVA, m_bot) },{ UnitType(sc2::UNIT_TYPEID::ZERG_SPIRE, m_bot), UnitType(sc2::UNIT_TYPEID::ZERG_GREATERSPIRE, m_bot) },{} };
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_DRONE, m_bot)] =                      { sc2::Race::Zerg, 0, 0, 1, 0, true, false, true, false, false, false, false, sc2::ABILITY_ID::TRAIN_DRONE, 0, { UnitType(sc2::UNIT_TYPEID::ZERG_LARVA, m_bot) }, {}, {} };
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_DRONEBURROWED, m_bot)] =				 { sc2::Race::Zerg, 0, 0, 1, 0, true, false, true, false, false, false, false, sc2::ABILITY_ID::TRAIN_DRONE, 0,{ UnitType(sc2::UNIT_TYPEID::ZERG_LARVA, m_bot) },{},{} };
	...
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_HYDRALISKBURROWED, m_bot)] =			 { sc2::Race::Zerg, 0, 0, 2, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_HYDRALISK, 0,{ UnitType(sc2::UNIT_TYPEID::ZERG_LARVA, m_bot) },{ UnitType(sc2::UNIT_TYPEID::ZERG_HYDRALISKDEN, m_bot), UnitType(sc2::UNIT_TYPEID::ZERG_LURKERDENMP, m_bot) },{} };
	...
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_INFESTORBURROWED, m_bot)] =			 { sc2::Race::Zerg, 0, 0, 2, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_INFESTOR, 0,{ UnitType(sc2::UNIT_TYPEID::ZERG_LARVA, m_bot) },{ UnitType(sc2::UNIT_TYPEID::ZERG_INFESTATIONPIT, m_bot) },{} };
	...
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_ROACHBURROWED, m_bot)] =				 { sc2::Race::Zerg, 0, 0, 2, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_ROACH, 0,{ UnitType(sc2::UNIT_TYPEID::ZERG_LARVA, m_bot) },{ UnitType(sc2::UNIT_TYPEID::ZERG_ROACHWARREN, m_bot) },{} };
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_RAVAGER, m_bot)] =                    { sc2::Race::Zerg, 0, 0, 2, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::MORPH_RAVAGER, 0, { UnitType(sc2::UNIT_TYPEID::ZERG_ROACH, m_bot) }, { UnitType(sc2::UNIT_TYPEID::ZERG_ROACHWARREN, m_bot) }, {} };
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_RAVAGERCOCOON, m_bot)] =              { sc2::Race::Zerg, 0, 0, 2, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::MORPH_RAVAGER, 0, { UnitType(sc2::UNIT_TYPEID::ZERG_ROACH, m_bot) }, { UnitType(sc2::UNIT_TYPEID::ZERG_ROACHWARREN, m_bot) }, {} };
    ...
    m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_ULTRALISKBURROWED, m_bot)] =          { sc2::Race::Zerg, 0, 0, 6, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_ULTRALISK, 0, { UnitType(sc2::UNIT_TYPEID::ZERG_LARVA, m_bot) }, { UnitType(sc2::UNIT_TYPEID::ZERG_ULTRALISKCAVERN, m_bot) }, {} };
	...
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_ZERGLINGBURROWED, m_bot)] =			 { sc2::Race::Zerg, 0, 0, 1, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_ZERGLING, 0,{ UnitType(sc2::UNIT_TYPEID::ZERG_LARVA, m_bot) },{ UnitType(sc2::UNIT_TYPEID::ZERG_SPAWNINGPOOL, m_bot) },{} };
	...
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::ZERG_QUEENBURROWED, m_bot)] =				 { sc2::Race::Zerg, 0, 0, 2, 0, true, false, false, false, false, false, false, sc2::ABILITY_ID::TRAIN_QUEEN, 0,{ UnitType(sc2::UNIT_TYPEID::ZERG_HATCHERY, m_bot), UnitType(sc2::UNIT_TYPEID::ZERG_LAIR, m_bot), UnitType(sc2::UNIT_TYPEID::ZERG_HIVE, m_bot) },{ UnitType(sc2::UNIT_TYPEID::ZERG_SPAWNINGPOOL, m_bot) },{} };
	...
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::NEUTRAL_DESTRUCTIBLECITYDEBRIS6X6, m_bot)] = { sc2::Race::Random, 0, 0, 0, 0, true, false, false, false, false, false, false, 0, 0,{ UnitType() },{ UnitType() },{} };
...
void TechTree::initUpgradeData()
{
    ...
    m_upgradeData[sc2::UPGRADE_ID::BANSHEESPEED] =                      { sc2::Race::Terran, 150, 150, 0, 2720, false, false, false, false, false, false, false, sc2::ABILITY_ID::RESEARCH_BANSHEEHYPERFLIGHTROTORS, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_STARPORTTECHLAB, m_bot) }, {}, {} };
    m_upgradeData[sc2::UPGRADE_ID::BATTLECRUISERENABLESPECIALIZATIONS]= { sc2::Race::Terran, 150, 150, 0,  960, false, false, false, false, false, false, false, sc2::ABILITY_ID::RESEARCH_BATTLECRUISERWEAPONREFIT, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_FUSIONCORE, m_bot) }, {}, {} };
    m_upgradeData[sc2::UPGRADE_ID::DRILLCLAWS] =                        { sc2::Race::Terran, 150, 150, 0, 1760, false, false, false, false, false, false, false, sc2::ABILITY_ID::RESEARCH_DRILLINGCLAWS, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_FACTORYTECHLAB, m_bot) }, {}, {} };
    m_upgradeData[sc2::UPGRADE_ID::HIGHCAPACITYBARRELS] =               { sc2::Race::Terran, 150, 150, 0, 1760, false, false, false, false, false, false, false, sc2::ABILITY_ID::RESEARCH_INFERNALPREIGNITER, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_FACTORYTECHLAB, m_bot) }, {}, {} };
    ...
    m_upgradeData[sc2::UPGRADE_ID::CYCLONELOCKONDAMAGEUPGRADE/*144*/] = { sc2::Race::Terran, 100, 100, 0, 1760, false, false, false, false, false, false, false, sc2::ABILITY_ID::RESEARCH_CYCLONELOCKONDAMAGE/*769*/, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_FACTORYTECHLAB, m_bot) }, {}, {} };
	...
	m_upgradeData[sc2::UPGRADE_ID::BATTLECRUISERENABLESPECIALIZATIONS] ={ sc2::Race::Terran, 150, 150, 0, 1050, false, false, false, false, false, false, false, sc2::ABILITY_ID::RESEARCH_BATTLECRUISERWEAPONREFIT, 0, { UnitType(sc2::UNIT_TYPEID::TERRAN_FUSIONCORE, m_bot) }, {}, {} };
...
void TechTree::initBuildingAbilitiesProductionTypes()
{
	for (const auto & unitTypeData : m_unitTypeData)
	{
		const auto & unitType = unitTypeData.first;
		const auto & buildAbility = unitTypeData.second.buildAbility;
		const auto & producers = unitTypeData.second.whatBuilds;
		for (const auto & producer : producers)
		{
			m_buildingAbilitiesProductionTypes[producer.getAPIUnitType()][buildAbility.ToType()] = unitType;
		}
	}
}
...
const UnitType & TechTree::getUnitTypeFromBuildingAbility(sc2::UNIT_TYPEID buildingType, sc2::ABILITY_ID ability)
{
	return m_buildingAbilitiesProductionTypes[buildingType][ability];
}
