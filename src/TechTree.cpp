...
void TechTree::initUnitTypeData()
{
	...
	m_unitTypeData[UnitType(sc2::UNIT_TYPEID::TERRAN_RICHREFINERY, m_bot)] =			 { sc2::Race::Terran, 0, 0, 0, 0, true, true, false,  true, false, false, false, sc2::ABILITY_ID::BUILD_REFINERY, 0,{ UnitType(sc2::UNIT_TYPEID::TERRAN_SCV, m_bot) },{},{} };
